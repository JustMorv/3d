/* @license three-dragger v1.0.2 | (c) Qingrong Ke <keqingrong1992@gmail.com> (https://keqingrong.github.io/) */
...
var MouseDragger = /*#__PURE__*/function (_EventEmitter) {
  ...
  function MouseDragger(objects, camera, domElement) {
    ...
    _this = _callSuper(this, MouseDragger);
    /**
     ...
     * @param {MouseEvent} event
     */
    _defineProperty(_this, "onDocumentMouseMove", function (event) {
      var self = _this;
      if (!self.enabled) {
        return;
      }
     ...
     * @param {MouseEvent} event
     */
    _defineProperty(_this, "onDocumentMouseUp", function (event) {
      var self = _this;
      if (!self.enabled) {
        return;
      }
  ...
  return _createClass(MouseDragger, [{
    key: "update",
    ...
    value: function emitEvent(eventName, target, position, domEvent) {
      var self = this;
      _superPropGet(MouseDragger, "emit", this, 3)([eventName, {
        target: target,
        mouse: self.mouse,
        position: position,
        event: domEvent
